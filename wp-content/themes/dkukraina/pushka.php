<?php
/**
 * Template name: шаблон Пушкинская карта
 */
		...
		<nav class="breadcrumbs" aria-label="breadcrumb" data-breadcrumbs itemprop="http://schema.org/breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
			<ul class="breadcrumbs__list">
				...
				<li class="breadcrumbs__crumb" aria-current="page" data-breadcrumbs-crumb>
					<span class="breadcrumbs__text text-button" data-breadcrumbs-text title="Пушкинская карта">Пушкинская карта</span>
				</li>
			</ul>
		</nav>
	</div>

	<h1 class="h1 mb-24 mb-md-48" data-animate>Пушкинская карта</h1>
