...
<div class="wrap-pl-1 wrap-pr-1 indent-from-head">
        ...
        <nav class="breadcrumbs" aria-label="breadcrumb" data-breadcrumbs itemprop="http://schema.org/breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
            <ul class="breadcrumbs__list">
                ...
                <li class="breadcrumbs__crumb" aria-current="page" data-breadcrumbs-crumb>
                    <span class="breadcrumbs__text text-button" data-breadcrumbs-text title="Новости">Новости</span>
                </li>
            </ul>
        </nav>
    </div>

    <h1 class="h1 mb-24 mb-md-48" data-animate>Новости</h1>
    ...
    <div class="mb-64 mb-md-96" id="ajax-pager">
        ...
        <div class="card-list-footer mt-16 mt-md-40 js-ajax-pagenation" data-animate>
            <div class="card-list-footer__buttons">
                <a href="/news/?paged=<?php echo $paged + 1;?>" class="btn text-button" data-show-more>
                    <span>загрузить ещё</span>
                </a>
            </div>
            <div class="card-list-footer__counter">
                <?php
                $category = get_category('8');
                $count = $category->category_count
                ?>
                <div class="text-label color-gray">Показано <?php echo $key + 1;?> из <?php echo $count;?></div>
            </div>
        </div>
        <div class="mb-64 mb-md-96"></div>
    </div>
</div>
<?php get_footer(); ?>
